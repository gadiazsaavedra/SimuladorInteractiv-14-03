...
const productos = ['Ford Focus XTE 2.0 modelo 2020', 'Fiat Uno 1.5 modelo 2019', 'Renault Duster 2.0 Pera', 'Frutillas', 'Anana', 'Durazno', 'Ciruelas', 'Arandanos', 'Papaya', 'Mango']
const carrito = []
